package com.tuxcuiabano.socialbooks.resources;
...
import com.tuxcuiabano.socialbooks.services.LivrosService;
...
public class LivrosResources {
	...
	public ResponseEntity<?> buscar(@PathVariable("id") Long id, HttpServletResponse response) {
		...
		Livro livro = livrosService.buscar(id);		//return livrosRepository.findOne(id); - versao anterior do spring
